...
export function PublicHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#dfe8e2] bg-white">
      <nav
        aria-label="Primary navigation"
        className="mx-auto flex h-[72px] max-w-[1240px] items-center justify-between px-4 sm:px-6 lg:px-8"
      >
        <a
        ...
        <div className="hidden items-center gap-7 lg:flex">
          {navigationItems.map((item) => (
            <a
              className="inline-flex min-h-11 items-center text-sm font-semibold text-[#405149] transition-colors hover:text-[#0d7652] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0d7652] focus-visible:ring-offset-4"
              href={item.href}
              key={item.href}
            >
              {item.label}
        ...
        <div className="hidden items-center gap-2.5 lg:flex">
          <Button
            className="h-11 border-[#cad8cf] px-5 font-bold text-[#21352c] hover:bg-[#f1f7f3]"
            nativeButton={false}
          ...
          <Button
            className="h-11 bg-[#0d7652] px-5 font-bold text-white hover:bg-[#095f42]"
            nativeButton={false}
        ...
        <Button
          ...
          className="size-11 border-[#cad8cf] text-[#21352c] hover:bg-[#f1f7f3] lg:hidden"
        ...
        >
          <div className="mx-auto flex max-w-[1240px] flex-col">
            ...
            <div className="mt-3 grid gap-3 border-t border-[#dfe8e2] pt-4 min-[420px]:grid-cols-2">
              <Button
                className="h-11 border-[#cad8cf] font-bold"
                nativeButton={false}
